...
TableService.updateTerms("https://docs.google.com/spreadsheets/d/128SFltBPse_qao9Yobkw5eCavPjNjMqSfgeBRz8kQ8Q/edit#gid=853840600")
    .then(result => {
...
//         ]
//     ]
//     return TermService.createRecordsFromTable(tableBR, "pt-BR").then( () => TermService.createRecordsFromTable(tableUS,"en-US") )
// }
// populateTerm().then( () => populateInteraction() )
